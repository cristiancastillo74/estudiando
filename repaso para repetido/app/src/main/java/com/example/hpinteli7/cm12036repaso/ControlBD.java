...
public class ControlBD {
    ...
    private static final String DROP_TABLE1 ="DROP TABLE IF EXISTS nota; ";
    private static final String DROP_TABLE2 ="DROP TABLE IF EXISTS materia; ";
    private static final String DROP_TABLE3 ="DROP TABLE IF EXISTS alumno; ";
...
// }
        ...
        switch(relacion){
            ...
            case 3:
            {
                ...
                Cursor c=db.query(true, "nota", new String[] {
                                "carnet" }, "carnet='"+alumno.getCarnet()+"'",null, null,
                        null, null, null);
                if(c.moveToFirst())
                    return true;
                else
    ...
    public String llenarBDCarnet(){
        ...
        final String[] VNcarnet =       {"OO12035","OF12044","GG11098","CC12021","OO12035","OF12044","GG11098"};
        final String[] VNcodmateria =   {"MAT115","PRN115","IEC115","TSI115","MAT115","PRN115","IEC115"};
        final String[] VNciclo =        {"12017","12017","12017","12017","22017","22017","22017"};
        final float[] VNnotafinal =     {4,3,4,7,6,10,7};
        abrir();
